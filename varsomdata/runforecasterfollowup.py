...
def make_comparison_plots(forecaster_dict, path=''):
    ...
    forecasters = [n for n,f in forecaster_dict.iteritems()]
    y_pos = np.arange(len(forecasters))

    all_danger_levels = [f.danger_levels_avg for n,f in forecaster_dict.iteritems()]
    all_danger_levels_std = [f.danger_levels_std for n,f in forecaster_dict.iteritems()]

    all_problems_pr_warning = [f.problems_pr_warning_avg for n,f in forecaster_dict.iteritems()]
    all_problems_pr_warning_std = [f.problems_pr_warning_std for n,f in forecaster_dict.iteritems()]

    all_nowcast_lengths = [f.nowcast_lengths_avg for n,f in forecaster_dict.iteritems()]
    all_nowcast_lengths_std = [f.nowcast_lengths_std for n,f in forecaster_dict.iteritems()]

    all_forecast_lengths = [f.forecast_lengths_avg for n,f in forecaster_dict.iteritems()]
    all_forecast_lengths_std = [f.forecast_lengths_std for n,f in forecaster_dict.iteritems()]
